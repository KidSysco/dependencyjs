...
describe('Error Handling Tests', () => {
  ...
  test('should throw a type exception if a boolean is passed', () => {
  ...
  test('should throw a type exception if a string is passed', () => {
    const dependencies = 'true';
    expect(() => orderResolver.getItemOrderByDependency(dependencies)).toThrow(
      TypeError
    );
  ...
  test('should throw a type exception if a 1D array is passed', () => {
    const dependencies = ['true'];
    expect(() => orderResolver.getItemOrderByDependency(dependencies)).toThrow(
      TypeError
    );
  ...
  test('should throw a type exception if -Infinity is passed', () => {
    const dependencies = -Infinity;
    expect(() => orderResolver.getItemOrderByDependency(dependencies)).toThrow(
      TypeError
    );
  });
